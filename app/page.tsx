...
export default async function Home() {
  ...
  return (
    <div style={{ background:'#f5f5f5' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 380px', minHeight:380 }}>
            <div style={{ background:'linear-gradient(135deg,#050505 0%,#180303 100%)', padding:'2.5rem 3rem', display:'flex', flexDirection:'column', justifyContent:'center', position:'relative', overflow:'hidden' }}>
              ...
              <p style={{ color:'rgba(255,255,255,0.5)', fontSize:14, lineHeight:1.7, maxWidth:400, marginBottom:'1.5rem' }}>
                Más de 300 productos de las mejores marcas mundiales.
              </p>
              <div style={{ display:'flex', gap:'0.75rem', flexWrap:'wrap' }}>
                <Link href="/tienda" style={{ background:'var(--red)', color:'white', padding:'12px 28px', fontFamily:'var(--font-body)', fontSize:14, fontWeight:700, textDecoration:'none', textTransform:'uppercase', letterSpacing:'0.04em' }}>Ver catálogo</Link>
                <Link href="/tienda?cat=Proteínas" style={{ background:'transparent', color:'white', padding:'11px 22px', fontFamily:'var(--font-body)', fontSize:14, fontWeight:700, textDecoration:'none', border:'1px solid rgba(255,255,255,0.25)', textTransform:'uppercase', letterSpacing:'0.04em' }}>Proteínas →</Link>
              </div>
            ...
            <div style={{ background:'linear-gradient(160deg,#1a1208 0%,#2a1c00 60%,#0a0a0a 100%)', padding:'2rem', display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', textAlign:'center', borderLeft:'1px solid rgba(255,255,255,0.04)' }}>
              ...
              <div style={{ fontSize:13, color:'rgba(255,255,255,0.45)', lineHeight:1.6, marginBottom:'1.5rem', maxWidth:220 }}>Beneficios Exclusivos<br/>Transforma tu experiencia de compra</div>
              <Link href="/distribuidores" style={{ background:'#FBEC96', color:'#111', padding:'10px 24px', fontFamily:'var(--font-body)', fontSize:13, fontWeight:700, textDecoration:'none', textTransform:'uppercase', letterSpacing:'0.04em' }}>DESCUBRE CÓMO</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Sección BUYMUSCLE / Nutrición deportiva + Novedades */}
          ...
          <div style={{ display:'grid', gridTemplateColumns:'280px 1fr', gap:'2.5rem', alignItems:'start' }}>
            <div style={{ paddingRight:'2rem', borderRight:'1px solid #e8e8e8' }}>
              ...
              <p style={{ fontSize:13, color:'#777', lineHeight:1.7, marginBottom:'1.25rem' }}>
                Compra suplementos deportivos en Canarias con BuyMuscle. Proteínas, creatina, aminoácidos y pre-entrenos de marcas líderes.
              </p>
              <Link href="/tienda" style={{ fontSize:13, fontWeight:700, color:'var(--red)', textDecoration:'none' }}>Ver todo el catálogo →</Link>
            </div>
            <div>
              <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'1rem' }}>
                <div style={{ fontSize:18, fontWeight:800, textTransform:'uppercase', color:'#111', letterSpacing:'0.02em' }}>NOVEDADES</div>
        ...
        <div className="container">
          <div style={{ display:'grid', gridTemplateColumns:'1fr auto', gap:'3rem', alignItems:'center' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'0.75rem', minWidth:180 }}>
              <Link href="/distribuidores/login" style={{ background:'var(--red)', color:'white', padding:'13px 24px', fontFamily:'var(--font-body)', fontSize:13, fontWeight:700, textDecoration:'none', textTransform:'uppercase', textAlign:'center', letterSpacing:'0.04em' }}>Acceder al portal</Link>
              <Link href="/distribuidores" style={{ background:'transparent', color:'rgba(255,255,255,0.5)', padding:'11px 20px', fontFamily:'var(--font-body)', fontSize:12, fontWeight:700, textDecoration:'none', border:'1px solid rgba(255,255,255,0.12)', textTransform:'uppercase', textAlign:'center', letterSpacing:'0.04em' }}>Más información</Link>
            </div>
          </div>
        </div>
      </section>
