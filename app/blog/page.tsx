        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:'1.5rem'}}>
          {filtered.map((art,i)=>(
            <a key={art.href} href={BASE+art.href} target="_blank" rel="noopener noreferrer"
              style={{background:'white',textDecoration:'none',color:'inherit',display:'flex',flexDirection:'column',border:'1px solid #ebebeb',transition:'box-shadow 0.2s,transform 0.2s',boxShadow:i===0?'0 2px 12px rgba(0,0,0,0.08)':'none'}}
