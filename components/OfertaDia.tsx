...
export default function OfertaDia() {
  ...
  useEffect(()=>{
    ...
    fetch(SB+'/rest/v1/products?active=eq.true&on_sale=eq.true&select=id,name,price_incl_tax,sale_price,image_url,brand,stock&limit=30',{
      ...
      if(Array.isArray(prods)&&prods.length>0){
        ...
        fetch(SB+'/rest/v1/products?active=eq.true&select=id,name,price_incl_tax,sale_price,image_url,brand,stock&limit=1&order=id.asc&offset='+((dayOfYear*7)%300),{
          headers:{apikey:SK,'Authorization':'Bearer '+SK}
