  ...
  return (
    <section style={{ padding:'2rem 0', background:'white', borderTop:'1px solid #ebebeb' }}>
      <div style={{ maxWidth:1280, margin:'0 auto', padding:'0 20px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'1rem', borderBottom:'2px solid #e0e0e0', paddingBottom:'0.75rem' }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:8 }}>
            <button onClick={goLeft}
              style={{ width:32, height:32, border:'1px solid', borderColor:atStart?'#eee':'#bbb', background:'white', cursor:atStart?'default':'pointer', display:'flex', alignItems:'center', justifyContent:'center', fontSize:18, color:atStart?'#ddd':'#444', fontFamily:'var(--font-body)', transition:'all 0.15s' }}
            ...
            <button onClick={goRight}
              style={{ width:32, height:32, border:'1px solid', borderColor:atEnd?'#eee':'#bbb', background:'white', cursor:atEnd?'default':'pointer', display:'flex', alignItems:'center', justifyContent:'center', fontSize:18, color:atEnd?'#ddd':'#444', fontFamily:'var(--font-body)', transition:'all 0.15s' }}
        ...
        {/* Track — SIN overflow:hidden en el padre */}
        <div
          ref={trackRef}
          onScroll={onScroll}
          style={{
