...
export default function WishlistBtn({productId,size=24}){
  ...
  return(
    <button onClick={toggle} disabled={loading} title={saved?'Quitar de favoritos':'Guardar en favoritos'} aria-label={saved?'Quitar de favoritos':'Guardar en favoritos'} aria-pressed={saved}
